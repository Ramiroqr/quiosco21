import { completeOrder } from "@/actions/complete-order-acton"
                ...
                <dl className="mt-6 space-y-4">
                        ...
                        {order.orderProducts.map(product => (
                            <div 
                                ...
                                className="flex items-center gap-2 border-t border-gray-200 last-of-type:border-b last-of-type:pb-3 pt-4"
                            >
