...
export default function ProductDetails({ item }: ProductDetailsProps) {
  ...
  return (
    <div className="shadow p-4 bg-white rounded-md border-t border-gray-200 mb-1">
      <div className="space-y-3">
        ...
        <div className="flex gap-5 px-12 py-2 bg-gray-100 w-full rounded-lg justify-around">
          <button
            type="button"
